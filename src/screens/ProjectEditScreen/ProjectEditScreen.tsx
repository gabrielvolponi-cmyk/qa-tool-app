...
export function ProjectEditScreen() {
  ...
  }, [clientId, description, name, project, status, updateProject]);
  ...
  if (!project) {
    return (
      <Screen>
        <Card>
          <Text>{strings.projects.detailBody}</Text>
        </Card>
      </Screen>
    );
  }
  ...
  return (
    <Screen scroll>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title} accessibilityRole="header">
            {strings.projects.edit.title}
          </Text>
          <Text style={styles.subtitle}>{strings.projects.edit.subtitle}</Text>
        </View>
        ...
        <Card accent>
          ...
          <Button
            title={strings.projects.edit.submit}
            onPress={onSubmit}
            loading={submitting}
            accessibilityHint={strings.projects.edit.submitHint}
          />
        </Card>
      ...
      <SuccessModal
        ...
        title={strings.projects.edit.successTitle}
        message={strings.projects.edit.successBody}
